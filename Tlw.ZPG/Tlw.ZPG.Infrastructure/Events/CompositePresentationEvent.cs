...
namespace Tlw.ZPG.Infrastructure.Events
{
    ...
    public class CompositePresentationEvent<TPayload> : EventBase
    {
        ...
        {
            return Subscribe(action, ThreadOption.PublisherThread,null);
        }
        ...
        /// The CompositePresentationEvent collection is thread-safe.
        /// </remarks>
        public SubscriptionToken Subscribe(Action<TPayload> action, ThreadOption threadOption, SynchronizationContext synchronizationContext)
        {
            return Subscribe(action, threadOption, synchronizationContext,false);
        }
        ...
        {
            return Subscribe(action, ThreadOption.PublisherThread,null, keepSubscriberReferenceAlive);
        }
        ...
        /// The CompositePresentationEvent collection is thread-safe.
        /// </remarks>
        public SubscriptionToken Subscribe(Action<TPayload> action, ThreadOption threadOption, SynchronizationContext synchronizationContext, bool keepSubscriberReferenceAlive)
        {
            return Subscribe(action, threadOption,synchronizationContext, keepSubscriberReferenceAlive, null);
        }
        ...
        /// The CompositePresentationEvent collection is thread-safe.
        /// </remarks>
        public virtual SubscriptionToken Subscribe(Action<TPayload> action, ThreadOption threadOption,SynchronizationContext synchronizationContext, bool keepSubscriberReferenceAlive, Predicate<TPayload> filter)
        {
            ...
            switch (threadOption)
            {
                ...
                case ThreadOption.UIThread:
                    subscription = new DispatcherEventSubscription<TPayload>(actionReference, filterReference, GetUIDispatcher(synchronizationContext));
                    break;
                default:
                    subscription = new EventSubscription<TPayload>(actionReference, filterReference);
                    break;
