...
{
    partial class ImageProcessBox : Control
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e) {
            ...
            if (isDrawed && this.canReset) {        //如果已经绘制 并且可以操作选取 判断操作类型
        ...
        protected override void OnKeyPress(KeyPressEventArgs e) {
            if (e.KeyChar == 'w')
                NativeMethods.SetCursorPos(MousePosition.X, MousePosition.Y - 1);
            else if (e.KeyChar == 's')
                NativeMethods.SetCursorPos(MousePosition.X, MousePosition.Y + 1);
            else if (e.KeyChar == 'a')
                NativeMethods.SetCursorPos(MousePosition.X - 1, MousePosition.Y);
            else if (e.KeyChar == 'd')
                NativeMethods.SetCursorPos(MousePosition.X + 1, MousePosition.Y);
            base.OnKeyPress(e);
        }
