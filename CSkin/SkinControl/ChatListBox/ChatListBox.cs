...
namespace CCWin.SkinControl
{
    ...
    public partial class ChatListBox : Control
    {
        ...
        private Color vipFontColor = Color.FromArgb(0, 255, 0, 0);
        /// <summary>
        /// 用户备注字体的颜色
        /// </summary>
        [DefaultValue(typeof(Color), "0, 255, 0, 0"), Category("好友")]
        [Description("Vip用户备注字体的颜色")]
        public Color VipFontColor {
            get { return vipFontColor; }
            set { vipFontColor = value; }
        }
        #endregion
                ...
                if (this.IconSizeMode == ChatListItemIcon.Small) //小图标模式
                {
                    if (subItem.PlatformTypes == PlatformType.PC) //PC端
                    {
                        if (subItem.Status == ChatListSubItem.UserStatus.QMe)
                            g.DrawImage(global::CCWin.Properties.Resources.Small_Qme, new Rectangle(subItem.HeadRect.Right - 9, subItem.HeadRect.Bottom - 9, 9, 9));
                        if (subItem.Status == ChatListSubItem.UserStatus.Away)
                            g.DrawImage(global::CCWin.Properties.Resources.Small_away, new Rectangle(subItem.HeadRect.Right - 9, subItem.HeadRect.Bottom - 9, 9, 9));
                        if (subItem.Status == ChatListSubItem.UserStatus.Busy)
                            g.DrawImage(global::CCWin.Properties.Resources.Small_busy, new Rectangle(subItem.HeadRect.Right - 9, subItem.HeadRect.Bottom - 9, 9, 9));
                        if (subItem.Status == ChatListSubItem.UserStatus.DontDisturb)
                            g.DrawImage(global::CCWin.Properties.Resources.Small_mute, new Rectangle(subItem.HeadRect.Right - 9, subItem.HeadRect.Bottom - 9, 9, 9));
                    } else if (subItem.PlatformTypes == PlatformType.Iphone) //Iphone端
                    {
                        g.DrawImage(global::CCWin.Properties.Resources.Small_IPhoneQQ_Head_Small, new Rectangle(subItem.HeadRect.Right - 9, subItem.HeadRect.Bottom - 11, 9, 11));
                    } else if (subItem.PlatformTypes == PlatformType.WebQQ) //WebQQ端
                    {
                        if (subItem.Status == ChatListSubItem.UserStatus.Away)
                            g.DrawImage(global::CCWin.Properties.Resources.Small_ImQQAway, new Rectangle(subItem.HeadRect.Right - 10, subItem.HeadRect.Bottom - 10, 10, 10));
                        if (subItem.Status == ChatListSubItem.UserStatus.Online)
                            g.DrawImage(global::CCWin.Properties.Resources.Small_ImQQOnline, new Rectangle(subItem.HeadRect.Right - 10, subItem.HeadRect.Bottom - 10, 10, 10));
                    } else if (subItem.PlatformTypes == PlatformType.Aandroid) //安卓端
                    {
                        g.DrawImage(global::CCWin.Properties.Resources.Small_MobilePhoneQQOn, new Rectangle(subItem.HeadRect.Right - 13, subItem.HeadRect.Bottom - 13, 13, 13));
                    }
                } else //大图标模式
                {
                    if (subItem.PlatformTypes == PlatformType.PC) //PC端
                    ...
                    {
                        g.DrawImage(global::CCWin.Properties.Resources.IPhoneQQ_Head_Big, new Rectangle(subItem.HeadRect.Right - 14, subItem.HeadRect.Bottom - 20, 14, 20));
                    } else if (subItem.PlatformTypes == PlatformType.WebQQ) //WebQQ端
                    {
                        if (subItem.Status == ChatListSubItem.UserStatus.QMe)
                            g.DrawImage(global::CCWin.Properties.Resources.WebQQQme, new Rectangle(subItem.HeadRect.Right - 20, subItem.HeadRect.Bottom - 20, 20, 20));
                        if (subItem.Status == ChatListSubItem.UserStatus.Away)
                            g.DrawImage(global::CCWin.Properties.Resources.WebQQAway, new Rectangle(subItem.HeadRect.Right - 20, subItem.HeadRect.Bottom - 20, 20, 20));
                        if (subItem.Status == ChatListSubItem.UserStatus.Busy)
                            g.DrawImage(global::CCWin.Properties.Resources.WebQQBusy, new Rectangle(subItem.HeadRect.Right - 20, subItem.HeadRect.Bottom - 20, 20, 20));
                        if (subItem.Status == ChatListSubItem.UserStatus.DontDisturb)
                            g.DrawImage(global::CCWin.Properties.Resources.WebQQMute, new Rectangle(subItem.HeadRect.Right - 20, subItem.HeadRect.Bottom - 20, 20, 20));
                        if (subItem.Status == ChatListSubItem.UserStatus.Online)
                            g.DrawImage(global::CCWin.Properties.Resources.WebQQOnline, new Rectangle(subItem.HeadRect.Right - 20, subItem.HeadRect.Bottom - 20, 20, 20));
                    } else if (subItem.PlatformTypes == PlatformType.Aandroid) //安卓端
                    {
                        g.DrawImage(global::CCWin.Properties.Resources.MobilePhoneQQOn, new Rectangle(subItem.HeadRect.Right - 20, subItem.HeadRect.Bottom - 20, 20, 20));
                    }
                }
            }
