...
{
    [Docking(DockingBehavior.Ask), ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch), ToolboxBitmap(typeof(SkinHtmlEditor), "Resources.HTML.bmp")]
    public sealed partial class SkinHtmlEditor : UserControl
    {
        /// <summary>
        /// 公共事件，如果内部处理的错误出现了则引发
        /// </summary>
        [Category("Exception"), Description("出现内部处理的错误")]
        public event HtmlExceptionEventHandler HtmlException;

        /// <summary>
        /// 公共事件，如果导航事件被捕获了
        /// </summary>
        [Category("Navigation"), Description("导航事件被触发了")]
        ...
        private const string HTML_TITLE_EDIT = "HTML源码";
        ...
        private string removeButtons;
        [Description("要隐藏的工具栏Button(格式：Cut,Paste)"), Category("SkinRemove")]
        ...
        [Description("要隐藏的右键菜单子项(格式：Cut,Paste)"), Category("SkinRemove")]
        ...
        [Description("设置或获取HTML源码"), Category("Textual")]
        public string BodyInnerHTML
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("对控件的内部HTML不能被设置。", "SetInnerHtml", ex);
                }
            }
        }

        /// <summary>
        /// 删除参考方法：转到 about:blank
        /// </summary>
        ...
        /// HTML值可以在运行时使用
        /// </summary>
        [Category("Textual"), Description("设置或获取正文的值")]
        ...
        public string BodyInnerText
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("对HTML源操作失败", "SetInnerText", ex);
                }
        ...
        /// <summary>
        /// 属性返回的任何URL并且用来加载当前文档
        /// </summary>
        [Category("Textual"), Description("用于加载文档的URL")]
        ...
        /// 文本的编辑状态
        /// </summary>
        [Category("RuntimeDisplay"), Description("标记的内容为只读")]
        [DefaultValue(false)]
        ...
        /// 在设置操作属性的定义
        /// </summary>
        [Category("Textual"), Description("完整的HTML值，包括body和标签")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        public string BodyHtml
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("HTML外置源操作失败.", "SetBodyHtml", ex);
                }
            }
        ...
        /// 属性确定是否应显示滚动条
        /// </summary>
        [Category("RuntimeDisplay"), Description("滚动条显示控件")]
        ...
        /// 自动换行
        /// </summary>
        [Category("RuntimeDisplay"), Description("是否启用自动换行")]
        [DefaultValue(true)]
        ...
        /// 复位和序列化的值定义
        /// </summary>
        [Category("Textual"), Description("定义字体的样式")]
        ...
        [Category("Appearance"), Description("工具栏是否可见"), DefaultValue("true")]
        ...
        [Category("Appearance"), Description("状态条控件是否可见"), DefaultValue("true")]
        ...
        [Category("Appearance"), Description("控件的HTML编辑器是否可见"), DefaultValue("true")]
        public bool ShowWb
        {
            get
            {
        ...
        [Category("Appearance"), Description("控件是否有快捷键"), DefaultValue("true")]
        ...
        //隐藏Button
        private void RemoveButtonss()
        {
            string removeButton = RemoveButtons;
            ArrayList arrList = null;
            if (!string.IsNullOrEmpty(removeButton))
            {
                string[] removeButtons = removeButton.Split(',');
                arrList = ArrayList.Adapter(removeButtons);
            }
        ...
        private void RemoveMenus()
        {
            ...
            {
                string[] removeMenus = RemoveMenu == null ? null : removeMenu.Split(',');
                arrList = removeMenus == null ? null : ArrayList.Adapter(removeMenus);
            }
            ...
            try
            {
                ...
                switch (command)
                {
                    ...
                    case INTERNAL_COMMAND_ABOUT:
                        ...
                        {
                            Process.Start("http://www.cskin.net");
                        }
                        break;
                    default:
