        ...
        private void WmPaintWater(ref Message m)
        {
            using (Graphics g = Graphics.FromHwnd(base.Handle))
            {
                    ...
                    !this.Focused)
                {
                    ...
                    TextRenderer.DrawText(g, this._waterText, new Font(CCWin.Localization.Localizer.DefaultFont.FontFamily, 8.5f), this.ClientRectangle, this._waterColor, flags);
                }
            }
        }
        #endregion
