            ...
            switch (btns)
            {
                case MessageBoxButtons.OKCancel:
                    buttonArray = new Button[] {
                        InnerCreateButton(Languages.DialogButton.BtnOk, DialogResult.OK), 
                        InnerCreateButton(Languages.DialogButton.BtnCancel, DialogResult.Cancel) };
                    base.CancelButton = buttonArray[1];
                    break;

                case MessageBoxButtons.AbortRetryIgnore:
                    buttonArray = new Button[] { 
                        InnerCreateButton(Languages.DialogButton.BtnAbort, DialogResult.Abort),
                        InnerCreateButton(Languages.DialogButton.BtnRetry, DialogResult.Retry),
                        InnerCreateButton(Languages.DialogButton.BtnIgnore, DialogResult.Ignore) };
                ...
                case MessageBoxButtons.YesNoCancel:
                    buttonArray = new Button[] {
                        InnerCreateButton(Languages.DialogButton.BtnYes, DialogResult.Yes), 
                        InnerCreateButton(Languages.DialogButton.BtnNo, DialogResult.No), 
                        InnerCreateButton(Languages.DialogButton.BtnCancel, DialogResult.Cancel) };
                    base.CancelButton = buttonArray[2];
                    break;
